...
dt_df <- readr::read_csv("./DL_results/df_dt.csv")
...
```{r, echo = FALSE}
knitr::kable(dt_df, caption = "Comparing Systolic Coefficients", digits = 2)
```
...
```{r, echo = FALSE}
knitr::kable(sys_table, caption = "Systolic LASSO Coefficients", digits = 2)
knitr::kable(diff_table, caption = "Difference LASSO Coefficients", digits = 2)
```
