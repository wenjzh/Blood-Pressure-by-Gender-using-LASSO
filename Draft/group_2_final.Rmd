...
=======
In order to find the variables that have the greatest effect(s) on blood pressure, we will use LASSO, choosing $\lambda$ by CV. 
>>>>>>> d5d3a43a652d6a9dbe3b3cb7ead0623db00d1034
...
We used "cv.glmnet" to choose the $\lambda$ with minimum MSE. Slight changes in $\lambda$ did not cause dramatic differences in coefficient results.
