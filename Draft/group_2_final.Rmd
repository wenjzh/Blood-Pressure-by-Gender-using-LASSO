...
Remember that gender = 0.5 representing male and -0.5 representing female. In our common sense, the propotion of men with hypertention are higher than that of women, which is also supported by our results: coefficients of gender in both model are positive.
...
/// set up data
import sasxport5 "../DATA/BPX_I.XPT", clear
